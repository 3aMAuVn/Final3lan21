(function () {
  ...
  function initPricingTool() {
    ...
    var isVi = docLang.indexOf('vi') === 0 || document.body.classList.contains('page-vi') || pathLower.indexOf('/vi/') !== -1;
    var isZh = docLang.indexOf('zh') === 0 || document.body.classList.contains('page-cn') || pathLower.indexOf('/cn/') !== -1;
